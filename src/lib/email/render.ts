...
export function renderEmail(tpl: EmailTemplate, opts: RenderOptions = {}): string {
  ...
  const banner = tpl.banner_url
    ? `<tr><td style="padding:0;font-size:0;line-height:0;">
        <img src="${escapeHtml(tpl.banner_url)}" width="100%" alt="" style="display:block;width:100%;max-width:100%;height:auto;max-height:100px;object-fit:cover;object-position:center ${tpl.banner_position ?? 'center'};border:0;">
      </td></tr>`
    : ''
