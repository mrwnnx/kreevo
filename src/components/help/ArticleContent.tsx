  ...
  return (
    <article
      className="
        ...
        [&_blockquote]:border-s-4 [&_blockquote]:border-primary/40 [&_blockquote]:bg-white/45 [&_blockquote]:rounded-e-lg [&_blockquote]:px-4 [&_blockquote]:py-3 [&_blockquote]:my-4 [&_blockquote]:italic [&_blockquote]:text-foreground/80
        ...
        [&_th]:text-start [&_th]:font-semibold [&_th]:bg-white/45 [&_th]:px-3 [&_th]:py-2 [&_th]:border [&_th]:border-border
