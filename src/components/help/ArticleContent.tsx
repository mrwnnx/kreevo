  ...
  return (
    <article
      className="
        ...
        [&_ul]:my-4 [&_ul]:pl-6 [&_ul]:space-y-1.5 [&_ul]:list-disc
        [&_ol]:my-4 [&_ol]:pl-6 [&_ol]:space-y-1.5 [&_ol]:list-decimal
        [&_li]:text-[15px] [&_li]:leading-relaxed [&_li]:text-foreground/90
        [&_blockquote]:border-l-4 [&_blockquote]:border-primary/40 [&_blockquote]:bg-muted/40 [&_blockquote]:rounded-r-lg [&_blockquote]:px-4 [&_blockquote]:py-3 [&_blockquote]:my-4 [&_blockquote]:italic [&_blockquote]:text-foreground/80
        ...
        [&_th]:text-left [&_th]:font-semibold [&_th]:bg-muted/40 [&_th]:px-3 [&_th]:py-2 [&_th]:border [&_th]:border-border
